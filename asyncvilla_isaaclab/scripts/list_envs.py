...
All the environments are registered in the `asyncvilla_isaaclab` extension. They start
...
import asyncvilla_isaaclab.tasks  # noqa: F401


def main():
    """Print all environments registered in `asyncvilla_isaaclab` extension."""
